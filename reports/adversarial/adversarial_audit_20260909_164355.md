...
**Generated:** 2026-09-09 16:43:55 UTC  
...
## 1. Executive Summary
- **Overall Attack Success Rate (ASR):** `25.0%` (6/24 fraudulent postings evaded detection)
- **Pre-Attack Fraud Detection Rate:** `60.0%`
- **Post-Attack Fraud Detection Rate:** `45.0%` (Absolute drop: `15.0%`)
- **Mean Fraud Score Degradation:** `-0.0952`
- **Maximum Observed Score Suppression:** `0.8056`
...
| `unicode_homoglyphs` | 5 | 3 | 2 | **66.7%** | 60.0% | 20.0% | +0.2453 | 0.8056 | 85.7% |
| `leetspeak` | 5 | 3 | 1 | **33.3%** | 60.0% | 40.0% | +0.0539 | 0.2314 | 42.9% |
| `typos` | 5 | 3 | 0 | **0.0%** | 60.0% | 60.0% | +0.0511 | 0.2014 | 0.0% |
| `zero_width` | 5 | 3 | 0 | **0.0%** | 60.0% | 60.0% | -0.0115 | 0.0188 | 14.3% |
...
- **Score Shift:** `0.8786` (Fraudulent) $\longrightarrow$ `0.0730` (Legitimate) [Δ `0.8056`]
...
### Flip Example 3: `unicode_homoglyphs` (Sample: `regression_SUBTLE SCAM`)
- **Score Shift:** `0.6775` (Fraudulent) $\longrightarrow$ `0.2795` (Legitimate) [Δ `0.3980`]
- **Dropped Signals:** `whatsapp_contact`
- **Original Excerpt:**
...
- **Attacked Excerpt:**
  > *"Onlіnе Dаta Entry Еxесutivе



    Еarn up tо ₹50,000 per mоnth working frоm hоme.

    Nо рrіor experience required.



    Selесtеd саndіdаtes must соmplete а smаll verification..."*

### Flip Example 4: `benign_camouflage` (Sample: `regression_SUBTLE SCAM`)
...
### Flip Example 5: `leetspeak` (Sample: `regression_SENSITIVE INFORMATION SCAM`)
